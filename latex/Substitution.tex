...
\\
\>\AgdaFunction{lemmahvar} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{b}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \<[22]%
\>[22]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaComment{--rewrite ΛItv Λ (hvar a M) \_·\_ (a ∷ fv M) ƛ b}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{with} \AgdaBound{a} \AgdaFunction{≟ₐ} \AgdaBound{b}\<%
\\
...
\\
\>\AgdaFunction{lemmahvar≡} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}} \<[19]%
\>[19]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaKeyword{with} \AgdaFunction{lemmahvar} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{M}\AgdaSymbol{\}}\<%
\\
\>\AgdaSymbol{...} \AgdaSymbol{|} \AgdaInductiveConstructor{inj₁} \AgdaSymbol{(\_} \<[17]%
\>[17]\AgdaInductiveConstructor{,} \AgdaBound{hvaraMa≡a}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaBound{hvaraMa≡a}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaComment{--rewrite ΛItv Λ (hvar a M) \_·\_ (a ∷ fv M) ƛ a  = hvaraMa≡a}\<%
\\
...
\\
\>\AgdaComment{--  rewrite ΛItv Λ (hvar a M) \_·\_ (a ∷ fv M) ƛ b = hvaraMb≡b}\<%
\end{code}
...
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{→} \AgdaBound{N} \AgdaDatatype{∼α} \AgdaBound{P} \AgdaSymbol{→} \AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N} \AgdaFunction{]} \AgdaDatatype{∼α} \AgdaBound{M} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{P} \AgdaFunction{]}\<%
\end{code}
%</lemmaSubst2>
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmav} \AgdaBound{a} \AgdaBound{N∼αP} \<[16]%
\>[16]\<%
\\
\>\AgdaComment{--    rewrite  ΛItv Λ (hvar x N) \_·\_ (x ∷ fv N) ƛ a}\<%
\\
\>\AgdaComment{--    |        ΛItv Λ (hvar x P) \_·\_ (x ∷ fv P) ƛ a}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaKeyword{with} \AgdaBound{x} \AgdaFunction{≟ₐ} \AgdaBound{a}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\>[28]\<%
\\
\>\AgdaComment{--    rewrite  ΛIt· Λ (hvar x N) \_·\_ (x ∷ fv N) ƛ M M'}\<%
\\
\>\AgdaComment{--    |        ΛIt· Λ (hvar x P) \_·\_ (x ∷ fv P) ƛ M M'}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
...
\>[72]\<%
\\
\>\AgdaComment{--    rewrite  ΛItv Λ (hvar b (（ a ∙ b ） N)) \_·\_ (b ∷ fv (（ a ∙ b ） N)) ƛ b}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{rewrite} \<[15]%
\>[15]\AgdaFunction{lemmahvar≡} \AgdaSymbol{\{}\AgdaBound{b}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）} \AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{=} \AgdaFunction{ρ}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmav} \AgdaSymbol{.}\AgdaBound{c} \<[13]%
...
\>[85]\<%
\\
\>\AgdaComment{--    rewrite  ΛItv Λ (hvar a (（ a ∙ b ） N)) \_·\_ (a ∷ fv (（ a ∙ b ） N)) ƛ a}\<%
\\
\>[2]\AgdaIndent{5}{}\<[5]%
\>[5]\AgdaKeyword{rewrite} \<[14]%
\>[14]\AgdaFunction{lemmahvar≡} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{(}\AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）} \AgdaBound{N}\AgdaSymbol{)\}} \AgdaSymbol{=} \AgdaFunction{ρ} \<[49]%
\>[49]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>\AgdaComment{--    rewrite  ΛItv Λ (hvar c (（ a ∙ b ） N)) \_·\_ (c ∷ fv (（ a ∙ b ） N)) ƛ c}\<%
\\
\>[2]\AgdaIndent{5}{}\<[5]%
\>[5]\AgdaKeyword{rewrite} \<[14]%
\>[14]\AgdaFunction{lemmahvar≡} \AgdaSymbol{\{}\AgdaBound{c}\AgdaSymbol{\}} \AgdaSymbol{\{(}\AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）} \AgdaBound{N}\AgdaSymbol{)\}} \AgdaSymbol{=} \AgdaFunction{ρ} \<[49]%
\>[49]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\>[48]\<%
\\
\>\AgdaComment{--    rewrite  ΛItv Λ (hvar (（ a ∙ b ）ₐ c) (（ a ∙ b ） N)) \_·\_ ((（ a ∙ b ）ₐ c) ∷ fv (（ a ∙ b ） N)) ƛ (（ a ∙ b ）ₐ d)}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{rewrite} \<[15]%
\>[15]\AgdaFunction{lemmahvar≢} \AgdaSymbol{\{}\AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）ₐ} \AgdaBound{c}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）ₐ} \AgdaBound{d}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaFunction{（} \AgdaBound{a} \AgdaFunction{∙} \AgdaBound{b} \AgdaFunction{）} \AgdaBound{N}\AgdaSymbol{\}} \AgdaSymbol{(}\AgdaFunction{lemma∙ₐinj} \AgdaBound{c≢d}\AgdaSymbol{)} \AgdaSymbol{=} \AgdaFunction{ρ} \<[91]%
\>[91]\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemma·} \AgdaSymbol{:} \AgdaSymbol{(}\AgdaBound{M} \AgdaBound{N} \AgdaSymbol{:} \AgdaDatatype{Λ}\AgdaSymbol{)} \AgdaSymbol{→} \AgdaFunction{Ps[]} \AgdaBound{M} \AgdaSymbol{→} \AgdaFunction{Ps[]} \AgdaBound{N} \AgdaSymbol{→} \AgdaFunction{Ps[]} \AgdaSymbol{(}\AgdaBound{M} \AgdaInductiveConstructor{·} \AgdaBound{N}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemma·} \AgdaBound{M} \AgdaBound{N} \AgdaBound{Ps[]M} \AgdaBound{Ps[]N} \AgdaBound{a} \AgdaBound{b} \AgdaBound{c} \AgdaBound{P} \<[33]%
\>[33]\<%
\\
\>\AgdaComment{--    rewrite  ΛIt· Λ (hvar c P) \_·\_ (c ∷ fv P) ƛ M N}\<%
\\
\>\AgdaComment{--    |        ΛIt· Λ (hvar (（ a ∙ b ）ₐ c) (（ a ∙ b ） P)) \_·\_ ((（ a ∙ b ）ₐ c) ∷ fv (（ a ∙ b ） P)) ƛ (（ a ∙ b ） M) (（ a ∙ b ） N)}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaSymbol{=} \AgdaInductiveConstructor{∼α·} \AgdaSymbol{(}\AgdaBound{Ps[]M} \AgdaBound{a} \AgdaBound{b} \AgdaBound{c} \AgdaBound{P}\AgdaSymbol{)} \AgdaSymbol{(}\AgdaBound{Ps[]N} \AgdaBound{a} \AgdaBound{b} \AgdaBound{c} \AgdaBound{P}\AgdaSymbol{)}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemmav} \AgdaBound{a} \AgdaBound{x∉fva}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaKeyword{rewrite} \AgdaFunction{lemmafvv} \AgdaBound{a}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaKeyword{with} \AgdaSymbol{(}\AgdaInductiveConstructor{v} \AgdaBound{a}\AgdaSymbol{)} \AgdaFunction{[} \AgdaBound{x} \AgdaFunction{≔} \AgdaBound{N} \AgdaFunction{]} \AgdaSymbol{|} \AgdaFunction{lemmahvar} \AgdaSymbol{\{}\AgdaBound{x}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{a}\AgdaSymbol{\}} \AgdaSymbol{\{}\AgdaBound{N}\AgdaSymbol{\}}\<%
\\
\>[0]\AgdaIndent{2}{}\<[2]%
...
\>[38]\<%
\\
\>\AgdaComment{--    rewrite  ΛIt· Λ (hvar x N) \_·\_ (x ∷ fv N) ƛ M P}\<%
\\
\>[2]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaKeyword{rewrite} \<[15]%
\>[15]\AgdaFunction{lemmafv·} \AgdaBound{M} \AgdaBound{P}\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
...
\\
\>[0]\AgdaIndent{2}{}\<[2]%
\>[2]\AgdaFunction{lemma·} \AgdaBound{M'} \AgdaBound{P'} \AgdaBound{PscNM} \AgdaBound{PscNP} \AgdaBound{x≢y} \AgdaBound{x∉fvL} \<[37]%
\>[37]\<%
\\
\>\AgdaComment{--    rewrite  ΛIt· Λ (hvar x N) \_·\_  (x ∷ fv N) ƛ M' P'}\<%
\\
\>\AgdaComment{--    |        ΛIt· Λ (hvar y L) \_·\_  (y ∷ fv L) ƛ M' P'}\<%
\\
\>\AgdaComment{--    |        ΛIt· Λ (hvar y L) \_·\_  (y ∷ fv L) ƛ (M' [ x ≔ N ]) (P' [ x ≔ N ])}\<%
\\
\>\AgdaComment{--    |        ΛIt· Λ (hvar y L) \_·\_  (y ∷ fv L) ƛ (M' [ x ≔ N ]) (P' [ x ≔ N ])}\<%
\\
\>\AgdaComment{--    |        ΛIt· Λ (hvar x (N [ y ≔ L ])) \_·\_  (x ∷ fv (N [ y ≔ L ])) ƛ (M' [ y ≔ L ]) (P' [ y ≔ L ])}\<%
\\
\>[2]\AgdaIndent{4}{}\<[4]%
