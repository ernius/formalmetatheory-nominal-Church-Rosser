...
abstract
  ...
  ⇉h·· r1 r2 _ _ P Q =  (r1 P × r2 Q) ⊎ 
                        ∃ (λ x → ∃ (λ P' →  ∃ (λ Q' → r1 (ƛ x P') × r2 Q' × P · Q ∼α P' [ x ≔ Q' ])))  
  ...
  ⇉h··red :  (r1 r2 : Λ → Set)(M N : Λ) 
             → ∃  (λ P → ∃ (λ Q →  M ∼α P × N ∼α Q ×
                  ⇉h· r1 r2 (M · N) ≡  (r1 P × r2 Q) ⊎ 
                                       ∃ (λ x → ∃ (λ P' →  ∃ (λ Q' → r1 (ƛ x P') × r2 Q' × P · Q ∼α P' [ x ≔ Q' ])))))  
  ⇉h··red r1 r2 M N with ΛRec·' Set (⇉h·v r1 r2) (⇉h·· r1 r2) [] (⇉h·ƛ r1 r2) M N
  ... | P , Q , M∼P , N∼Q , ⇉h·≡ rewrite ⇉h·≡
    = {! P , Q , M∼P , N∼Q , refl!}
  --
  --     = ?
...
lemma⇉Equiv#Left {a} {b} {M} a#M b#M M⇉N 
  rewrite lemmaΛItEquiv# (Λ → Set) ⇉hv ⇉h· [] ⇉hƛ M a b a#M b#M 
  = M⇉N 
\end{code}

\begin{code}
lemma⇉αright : {M N P : Λ}  → M ⇉ N  → N ∼α P  → M ⇉ P
lemma⇉αright {v x}            refl   ∼αv       = refl
lemma⇉αright {M · M'}         MM'⇉N  N∼P
  rewrite ⇉h·αcompatible {ΛIt (Λ → Set) ⇉hv ⇉h· ([] , ⇉hƛ) M} {ΛIt (Λ → Set) ⇉hv ⇉h· ([] , ⇉hƛ) M'} N∼P 
  = MM'⇉N
...
lemma⇉Equiv#Right {a} {b} {M} {N} a#N b#N M⇉N 
  = lemma⇉αright {M} {N} {（ a ∙ b ） N} M⇉N (lemma#∼α {a} {b} {N} a#N b#N)
\end{code}
